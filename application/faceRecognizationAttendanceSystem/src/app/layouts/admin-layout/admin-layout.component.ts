...
export class AdminLayoutComponent implements OnInit {
    ...
    constructor(public storageService: StorageService, public location: Location, private router: Router) {
        let storageData = JSON.parse(storageService.getValue('isLogin'));
        let token = storageService.getValue('token');
        if (storageData != true) {
